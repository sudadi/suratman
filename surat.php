            ...
            <div class="container-fluid">
				...
				<div class="row well well-sm">
					...
					<div class="form-group col-md-12">	
						...
						<div class="col-md-3">
							<input type="text" name="noagenda" id="noagenda" class="form-control input-sm" value="<?=$noagenda; ?>" >
						</div>
					</div>
					<div class="form-group col-md-12">	
				...
				<div class="row well well-sm">
                	...
                	<table class="table table-striped table-condensed">
						...
						<?php
							...
							$sql = "SELECT * FROM tsurat LIMIT $start_from, $num_rec_per_page"; 
							$result = $db->query($sql);
							if ($db->affected_rows > 0) {
								while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
									...
									echo "<td class='text-nowrap'>".$row['tglterima']."</td>";
									echo "<td>".$row['nosurat']."</td>";
									echo "<td class='text-nowrap'>".$row['tglsurat']."</td>";
									echo "<td>".$row['asal']."</td>";
									...
									echo "&nbsp";
									echo "<a href='#' data-toggle=\"tooltip\" title=\"Cetak\"><span class=\"glyphicon glyphicon-print\"></span></a>" ;
									echo "</td>";
									echo "</tr>";
								}
							}
